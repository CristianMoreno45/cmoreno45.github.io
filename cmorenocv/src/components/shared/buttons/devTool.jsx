...
import { DiDotnet, DiJira, DiBitbucket, DiLinux, DiWindows, DiApple, DiRedhat } from 'react-icons/di';
import { FaPhp, FaAws, FaDocker, FaJava, FaJenkins } from "react-icons/fa";
import { SiSolidity, SiAzurepipelines, SiOracle, SiMicrosoftsqlserver, SiCsharp, SiMysql, SiApachejmeter, SiRabbitmq, SiMicrosoftazure, SiSubversion } from 'react-icons/si'
import { BiLogoJavascript, BiLogoReact, BiLogoAngular, BiLogoVuejs, BiLogoGoogleCloud, BiLogoGitlab } from 'react-icons/bi'
